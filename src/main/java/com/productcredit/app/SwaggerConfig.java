...
public class SwaggerConfig {
	...
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Finantial micro-productos-creditos Api Documentation", "Finantial micro-productos-creditos Api Documentation", "1.0",
